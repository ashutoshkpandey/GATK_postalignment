...
for file in BAM:
	...
	jobfile.write("#!/bin/bash\n#PBS -l walltime=480:00:00\n#PBS -l nodes=1:ppn=16\n#PBS -N GATK_Indel_Realigner_"+str(BAM[file])+"\n\njava -jar -Xmx40g /home/apandey/bio/GenomeAnalysisTK-2.1-9-gb90951c/GenomeAnalysisTK.jar  -T IndelRealigner -S LENIENT -bfh 4000 -rbs 2000000 -I "+str(file)+" -R "+str(Argument[3])+" -targetIntervals "+str(Argument[2])+"/"+str(BAM[file])+".intervals -o "+str(Argument[2])+"/"+str(BAM[file])+".bam  -known /home/apandey/mm10_Indels_17strains.vcf \n")	
