...
for file in BAM:
	...
	jobfile.write("#!/bin/bash\n#PBS -l walltime=480:00:00\n#PBS -l nodes=1:ppn=16\n#PBS -N Base_Recalibrator_Second_"+str(BAM[file])+"\n\njava -jar -Xmx40g /home/apandey/bio/GenomeAnalysisTK-2.1-9-gb90951c/GenomeAnalysisTK.jar  -T PrintReads -S LENIENT  -bfh 4000 -rbs 2000000 -I "+str(file)+" -R "+str(Argument[3])+" -BQSR "+str(Argument[2])+"/"+str(BAM[file])+".grp   -o "+str(Argument[2])+"/"+str(BAM[file])+".bam \n")
